...
function App() {
  ...
  const ul = planets.map(planet => <li className="list-group-item">{planet}</li>);

  return (
    <>
      <ul className="list-group">{ul}</ul>
      <BootstrapCard celebrities={celebrities[0]}/>
      <BootstrapCard celebrities={celebrities[1]}/>
    </>
  )
}
